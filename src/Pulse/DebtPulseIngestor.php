 ...
 * All writes are guarded by a class_exists check so this class is safe to
...
class DebtPulseIngestor
{
    ...
    public function push(ScanResult $result): void
    {
        ...
        Pulse::record('debt_score', 'project', $result->totalScore);

        // Snapshot: current grade, score, hours, item count, and category breakdown.
        Pulse::set('debt_summary', 'project', (string) json_encode([
            'grade'      => $result->grade,
        ...
        Pulse::set('debt_top_files', 'project', (string) json_encode(
            array_map(
        ...
        Pulse::set('debt_top_authors', 'project', (string) json_encode($result->topAuthors(10)));
    }
}
